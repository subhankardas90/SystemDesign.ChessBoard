...
class BoardTest {
    ...
    void shouldResetBoard(String notation, Class type, Color color) throws IllegalCellException {
        ...
        assertThat(board.getCell(PositionUtils.getPosition(notation)).getPiece().get(),
    ...
    void shouldNotMovePieceIfPositionsAreSame() throws IllegalCellException, IllegalMoveException {
        ...
        assertThrows(IllegalMoveException.class, () -> board.movePiece(
                new Move(PositionUtils.getPosition("b2"), PositionUtils.getPosition("b2"), new Player("test", WHITE)),
    ...
    void shouldNotMovePieceIfPieceDoesNotExist() throws IllegalCellException, IllegalMoveException {
        ...
        board.reset();
        assertThrows(IllegalMoveException.class, () -> board.movePiece(
                new Move(PositionUtils.getPosition("b3"), PositionUtils.getPosition("b4"), new Player("test", WHITE)),
                new Player("test", WHITE)));
    ...
    void shouldNotMovePieceIfPieceDoesNotBelongToPlayer() throws IllegalCellException, IllegalMoveException {
        ...
        board.reset();
        assertThrows(IllegalMoveException.class, () -> board.movePiece(
                new Move(PositionUtils.getPosition("b2"), PositionUtils.getPosition("b3"), new Player("test", BLACK)),
    ...
    void shouldNotMovePieceIfPieceCannotMoveToDestination() throws IllegalCellException, IllegalMoveException {
        ...
        board.reset();
        assertThrows(IllegalMoveException.class, () -> board.movePiece(
                new Move(PositionUtils.getPosition("b2"), PositionUtils.getPosition("b5"), new Player("test", WHITE)),
                new Player("test", WHITE)));
    ...
    void shouldNotMovePieceIfPieceAtDestinationBelongsToPlayer() throws IllegalCellException, IllegalMoveException {
        final Board board = new Board();
        board.reset();
        board.getCell(PositionUtils.getPosition("c3")).setPiece(new Pawn(WHITE));
        assertThrows(IllegalMoveException.class, () -> board.movePiece(
                new Move(PositionUtils.getPosition("b2"), PositionUtils.getPosition("c3"), new Player("test", WHITE)),
                new Player("test", WHITE)));
    ...
    void shouldProcessValidMove() throws IllegalCellException, IllegalMoveException {
        final Board board = new Board();
        board.reset();
        Piece pieceMoved = board.getCell(PositionUtils.getPosition("b2")).getPiece().get();

        board.movePiece(
                new Move(PositionUtils.getPosition("b2"), PositionUtils.getPosition("b3"), new Player("test", WHITE)),
                new Player("test", WHITE));
    ...
    void shouldProcessValidQueenSideCastlingMove() throws IllegalCellException, IllegalMoveException {
        final Board board = new Board();
        board.reset();
        Piece king = board.getCell(PositionUtils.getPosition("e1")).getPiece().get();
        Piece rook = board.getCell(PositionUtils.getPosition("a1")).getPiece().get();

        board.getCell(PositionUtils.getPosition("b1")).clearPiece();
        board.getCell(PositionUtils.getPosition("c1")).clearPiece();
        board.getCell(PositionUtils.getPosition("d1")).clearPiece();

        final Move move = new Move(PositionUtils.getPosition("e1"), PositionUtils.getPosition("a1"), new Player("test", WHITE));
    ...
    void shouldProcessValidKingSideCastlingMove() throws IllegalCellException, IllegalMoveException {
        ...
        board.reset();
        Piece king = board.getCell(PositionUtils.getPosition("e1")).getPiece().get();
        Piece rook = board.getCell(PositionUtils.getPosition("h1")).getPiece().get();

        board.getCell(PositionUtils.getPosition("f1")).clearPiece();
        board.getCell(PositionUtils.getPosition("g1")).clearPiece();

        final Move move = new Move(PositionUtils.getPosition("e1"), PositionUtils.getPosition("h1"), new Player("test", WHITE));
