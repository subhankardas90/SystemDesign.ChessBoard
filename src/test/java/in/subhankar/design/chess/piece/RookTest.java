...
class RookTest {
    ...
    void shouldValidateMove(final String startNotation,
        ...
        rook.setCell(new Cell(PositionUtils.getPosition(startNotation), WHITE));

        assertThat(rook.isValid(new Cell(PositionUtils.getPosition(endNotation), BLACK), board), is(isValid));
    }
